...
public class TestCaseResult {
	...
	public TestCaseResult(String name, File inputFile, File answerFile, long runtime, boolean wasStoppedEarly,
			Verdict verdict, String checkerMessage, File programOutputFile, File errorStreamFile) {
		this.name = name;
	 ...
	 * 
	 * @return A potentially multiline string which includes the test case name,
	 *         runtime, and some output (if WA)
	 */
	public String getTooltipString() {
		...
		tooltipStringBuilder.append(String.format(MESSAGES.getString("test_case_result_test_case") + " %s - "
				+ MESSAGES.getString("test_case_result_runtime") + ": %s", name, runtimeString));
	...
	static class Builder {
		...
		public TestCaseResult build() {
			return new TestCaseResult(name, inputFile, answerFile, runtime, wasStoppedEarly, verdict, checkerMessage,
					programOutputFile, errorStreamFile);
		}
	}
}
